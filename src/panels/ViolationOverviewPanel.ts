...
export class ViolationOverview {
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        const scriptUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "out/compiled", "ViolationOverview.js")
        );
        const cssUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "out/compiled", "ViolationOverview.css")
        );
        const tabulatorStyles = webview.asWebviewUri(vscode.Uri.joinPath(
            this._extensionUri,
            "media",
            "tabulator.css"
        ));
